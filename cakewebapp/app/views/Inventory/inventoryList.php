        ...
        <?php
            foreach($data as $item){
              ...
              <tr>
                  <td>$item->name</td>
                  <td>$item->quantity</td>
                  <td><a  type='submit' href='".BASE."/Inventory/addQuantity/".$item->inventory_id."/' class='btn btn-success'>+</a> <a type='submit' href='".BASE."/Inventory/removeQuantity/".$item->inventory_id."/' class='btn btn-danger'>-</a></td>
              <tr>";
            }
        ?>
        <tbody>
