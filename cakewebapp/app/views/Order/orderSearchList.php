        ...
        <?php
            foreach($data as $order){
              ...
              <tr>
                  ...
                  <td>$order->status</td>
                  <td><a class='btn btn-success' href='".BASE."/Order/detail/$order->order_id'>View Order</a>&nbsp&nbsp<a class='btn btn-danger' href='".BASE."/Order/delete/$order->order_id'>Delete</a>&nbsp<a class='btn btn-success' href='".BASE."/Order/modify/$order->order_id'>Edit</a>
                  </td>
              </tr>";
            }
        ?>
